...
def title():
    ...
    print(
        f"""{Fore.MAGENTA}                                
       _     _                      _     _   
      |_|___| |_ ___ ___    ___ ___|_|___| |_ 
      | | . | '_| -_|  _|  | . |_ -| |   |  _|
...
try:
    while True:
        haw = Hawker()
        title()
        command = input(f'    {Fore.MAGENTA}[{Fore.LIGHTMAGENTA_EX}root{Fore.LIGHTWHITE_EX}@{Fore.LIGHTMAGENTA_EX}j0k3r{Fore.LIGHTWHITE_EX} ~{Fore.MAGENTA}]#{Fore.LIGHTGREEN_EX} ')
